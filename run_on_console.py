    ...
    def get_nearest_beacon(cls):
        ...
        for key_color in cls.beacons.keys():
            ...
            if len(beacon_dict) == 0 or beacon_dict.get('average_rssi') < average_rssi:
                beacon_dict = {
                    'key_color': key_color,
                    'fg_color': cls.beacons.get(key_color).get('fg_color'),
...
async def run_getting_packets(master=None):
    ...
    count = 0
    while True:
        not_exists_color = ['RED', 'BLUE', 'YELLOW', 'GREEN', 'PURPLE', 'WHITE']
        ...
        for d in devices:
            ...
            if key_color is not None:
                if key_color == 'RED':
                    ...
                    BeaconManager.insert_rssi('WHITE', d.rssi)
                    master.text6.insert(
                        1.0,
                        'seq: ' + str(count) + ', rssi: ' + str(d.rssi) + 'dBm, average: ' + str(BeaconManager.get_average('WHITE')) + 'dBm\n'
                    )    
        ...
        if beacon_dic is not None and len(beacon_dic) > 0:
            ...
            master.nearest_beacon['fg'] = beacon_dic.get('fg_color')
        else:
...
class MainFrame(tk.Frame):
    ...
    def create_widgets(self):
        self.label1 = tk.Label(text='Beacon RED (AC:23:3F:26:45:15)', fg='red')
        ...
        self.label2 = tk.Label(text='Beacon BLUE (AC:23:3F:26:40:5B)', fg='blue')
        ...
        self.label3 = tk.Label(text='Beacon YELLOW (AC:23:3F:26:40:48)', fg='gold')
        ...
        self.label4 = tk.Label(text='Beacon GREEN (AC:23:3F:26:40:40)', fg='green')
        ...
        self.label5 = tk.Label(text='Beacon PURPLE (AC:23:3F:26:45:C2)', fg='purple')
        ...
        self.label6 = tk.Label(text='Beacon WHITE (AC:23:3F:26:42:EB)', fg='gray')
